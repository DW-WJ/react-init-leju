// @ts-nocheck
/**
 * Base on https://github.com/umijs/F:/study dw/react学习/umi-react/o1-umi/node_modules/umi-request
 */
import {
  extend,
  Context,
  ...
  RequestInterceptor,
  ResponseInterceptor,
} from 'F:/study dw/react学习/umi-react/o1-umi/node_modules/umi-request';
// @ts-ignore
...
import useUmiRequest, {
  UseRequestProvider,
} from 'F:/study dw/react学习/umi-react/o1-umi/node_modules/@ahooksjs/use-request';
import {
  BaseOptions,
  ...
  PaginatedParams,
  PaginatedResult,
} from 'F:/study dw/react学习/umi-react/o1-umi/node_modules/@ahooksjs/use-request/lib/types';
import { getToken } from './myAuth';
...
const request: RequestMethodInUmi = (url: any, options: any) => {
  ...
  return requestMethod(url, myOptions);
};
